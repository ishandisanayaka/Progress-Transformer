package com.example.progresstransformer.PdfLoder;
...
public class PdfRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PdfRecyclerViewAdapter(Context mContext, OnNoteListner onNoteListner2){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ((FileLayoutHolder)holder).videoTitle.setText(Constant.allpdfList.get(position).getName());
    ...
    public int getItemCount() {
        return Constant.allpdfList.size();
    }
